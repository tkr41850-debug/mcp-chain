...
| -- | ------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------- | --------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1  | README.md at repo root documents install (plugin-first), usage with all 4 `/mcp-chain:*` commands + manual `go install` path (SC-1)                    | VERIFIED      | README.md:19 `/plugin install`; README.md:32 `go install github.com/tkr41850-debug/mcp-chain/cmd/mcp-chain@latest`; 7 `/mcp-chain:(reg|wait|list|purge)` matches |
